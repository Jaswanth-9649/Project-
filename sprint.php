...
<div class="site-wrap">
    ...
    <!-- HOME -->
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('#');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
          ...
          <div class="col-lg-4">
            <div class="bg-light p-3 border rounded mb-4">
              ...
              <ul class="list-unstyled pl-3 mb-0">
                <li class="mb-2"><strong class="text-black">Published on:</strong> October 14, 2023</li>
                ...
                <li class="mb-2"><strong class="text-black">Application Deadline:</strong> December 28, 2023</li>
              </ul>
            </div>
